...
<p style="text-align: center;"><strong>Fonte</strong>: IDEO</p>
...
![]({{site.baseurl}}/images/blog/posts/2.png)
<p style="text-align: center;"><strong>Fonte</strong>: Tera </p>
...
![]({{site.baseurl}}/images/blog/posts/3.png)
<p style="text-align: center;"><strong>Fonte</strong>: Kitlivre</p>
...
<p style="text-align: center;"><strong>Fonte</strong>:Instagram Cliever3d</p>
...
<p style="text-align: center;"><strong>Fonte</strong>: Instagram Joaokato</p>
...
- [Golden circle](https://www.youtube.com/watch?v=POfQlg0V0Cc&feature=emb_title): desenvolvido por Simon Sinek, onde procuramos entender, primeiramente, o _porquê_ do problema, depois o _como_ e então _o que_ será a solução. 
...
![]({{site.baseurl}}/images/blog/posts/7.png)
<p style="text-align: center;"><strong>Fonte</strong>: IDEO</p>
...
- **Matriz impacto x esforço**: em uma matriz de quatro quadrantes de maior e menor esforço e maior e menor impacto, é possível ver com clareza qual é o cluster com maior valor e menor esforço para produção. [Aqui](https://www.voitto.com.br/blog/artigo/matriz-esforco-impacto) tem explicação em detalhe
- **Ponto de vista**: análise pela qual colocamos a pessoa no centro da análise identificando a dor, como ela age e se alguma solução existente resolve o problema dela. Resumir em uma única frase com os 3 pontos abaixo. 
...
[Aqui](https://agile-od.com/mental-model-dojo/design-thinking-pov-template) tem explicação em detalhe.
...
![]({{site.baseurl}}/images/blog/posts/8.png)
<p style="text-align: center;"><strong>Fonte</strong>: IDEO</p>

_"Ideação é o momento do processo de design em que você se concentra na geração de ideias. Mentalmente, isso representa um processo de “ir além” em relação a conceitos e respostas."_Livro _“An Introduction to Design Thinking”_, da d.school
...
Primeiramente é feito um warm up, ou seja, uma atividade rápida que serve para energizar e integrar o time que está desenvolvendo. Veja algumas opções [aqui](https://www.caroli.org/7-atividades-quebra-gelo-para-equipes-remotas/).

Então, a oficina se inicia com um **brain dumping**, onde os participantes irão escrever as ideias que possuem, livremente em post its, de forma individual. 
Podem ser inseridas algumas **constraints**, como: “e se tivéssemos todo o dinheiro do mundo para desenvolver a solução?”, ou “e se fossemos crianças, quais ideias teríamos?”.
Após esse momento individual é feito um **brainstorm**, discussão em grupo sobre as ideias criadas com o objetivo melhorá-las. 
...
![]({{site.baseurl}}/images/blog/posts/9.png)
<p style="text-align: center;"><strong>Fonte</strong>: IDEO</p>
...
Os protótipos podem ser desde um esboço em papel ou storyboards digitais e até um modelo físico de role-playing. Como Jerry Cao,  UX Content Strategist da UXPin, disse: _“protótipo é uma versão simulada ou amostra de um produto final, utilizada para testes antes do lançamento.”_
...
![]({{site.baseurl}}/images/blog/posts/10.png)
<p style="text-align: center;"><strong>Fonte</strong>:IDEO</p>
...
<p style="text-align: center;"><strong>Fonte</strong>:Design interaction</p>
